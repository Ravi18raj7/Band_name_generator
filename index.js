...
app.post("/submit", (req, res) => {
  ...
  //Then:
  const generatorName1= adj[(Math.floor(Math.random() * adj.length))];
  const generatorName2= noun[(Math.floor(Math.random() * noun.length))];
  //1. You should randomly pick an adjective from the const "adj" and a noun from const "noun",
  //scroll down to see the two arrays.
  res.render("index.ejs",{
    generatedName1:generatorName1,
    generatedName2:generatorName2,
  })
